			  ...
			  <?php } ?>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped jambo_table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
					  <?php
						$qnx = mysqli_query($connection,"select * from feedback");
						while($dn = mysqli_fetch_array($qnx)){
							...
							$tr2 = mysqli_fetch_array(mysqli_query($connection,"select title from lessons where id=".$dn['lesson']));
							$tr3 = mysqli_fetch_array(mysqli_query($connection,"select name from admin where id=".$dn['teacher']));

					  ?>
                        <tr>
						  <td><?php echo $tr1['name']; ?></td>
                          <td><?php echo $tr1['phone'].'; '.$tr1['email']; ?></td>
						<td><?php echo $tr2['title'].'<br/>...'.$tr3['name']; ?></th>
