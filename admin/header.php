            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a><i class="fa fa-area-chart"></i> Payment <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="funsum.php">Payment Summary</a></li>
                    </ul>
                  </li>
				  <li><a><i class="fa fa-dashboard"></i> Activity <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
					  ...
					  <li><a href="poruse.php">Portal Users</a></li>
					  <li><a href="worsta.php">Working Staff</a></li>
					  <li><a href="creann.php">Notice</a></li>
                    </ul>
                  </li>
