                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped jambo_table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
					  <?php
						$qnx1 = mysqli_query($connection,"select distinct student as sid from payment where confirm=1 and valid=0 and course in (select id from courses where deleted=0 and teacher=".$_SESSION['uid'].")");
