<?php include_once("header.php");
	$cel = mysqli_fetch_array(mysqli_query($connection,"SELECT * FROM courses where deleted=0 and id in (select distinct course from lessons where teacher=".$_SESSION['uid'].") order by id desc limit 1"));
	$cem = mysqli_query($connection,"select * from courses where deleted=0 and id in (select distinct course from lessons where teacher=".$_SESSION['uid'].")");
	...
	$tos = mysqli_num_rows(mysqli_query($connection,"select distinct student from payment where confirm=1 and valid=0 and course in (select distinct course from lessons where teacher=".$_SESSION['uid'].")"));
	$mos = mysqli_num_rows(mysqli_query($connection,"select distinct course from payment where confirm=1 and valid=0 and course in (select distinct course from lessons where teacher=".$_SESSION['uid'].")"));
	$fun = mysqli_num_rows(mysqli_query($connection,"select * from payment where confirm=1 and course in (select distinct course from lessons where teacher=".$_SESSION['uid'].")"));
	$fus = mysqli_num_rows(mysqli_query($connection,"select * from payment where confirm=1 and valid=0 and course in (select distinct course from lessons where teacher=".$_SESSION['uid'].")"));
	$usr = mysqli_num_rows(mysqli_query($connection,"select * from lessons where duration!=0 and teacher=".$_SESSION['uid']));
	$use = mysqli_num_rows(mysqli_query($connection,"select * from lessons where teacher=".$_SESSION['uid']));
	$mor = mysqli_num_rows(mysqli_query($connection,"select * from feedback where teacher=".$_SESSION['uid']));
	$moz = mysqli_num_rows(mysqli_query($connection,"select * from feedback where rep=1 and teacher=".$_SESSION['uid']));
...
?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
			...
			<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count"><a href='regstu.php'>
